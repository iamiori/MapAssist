...
namespace MapAssist.Settings
{
    public class MapAssistConfiguration
    {
        ...
        [YamlMember(Alias = "MouseItemInfo", ApplyNamingConventions = false)]
        public GameInfoConfiguration MouseItemInfo { get; set; }
        [YamlMember(Alias = "ShowUnitInfo", ApplyNamingConventions = false)]
        public GameInfoConfiguration ShowUnitInfo { get; set; }
...
public class HotkeyConfiguration
{
    ...
    [YamlMember(Alias = "MouseItemInfoKey", ApplyNamingConventions = false)]
    public char MouseItemInfoKey { get; set; }
    [YamlMember(Alias = "ShowUnitInfoKey", ApplyNamingConventions = false)]
    public char ShowUnitInfoKey { get; set; }
